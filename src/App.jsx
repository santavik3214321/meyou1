...
export default function App() {
  ...
  const consumeItem = () => {
    ...
    // Очищаем стол в Firebase
    set(tableRef, emptyState);
      ...
      <main className="relative z-10 flex-grow flex flex-col items-center justify-center p-4">
        ...
        {isLoading ? (
          <div className="flex flex-col items-center animate-pulse text-white/50">
            ...
            <p className="text-xs uppercase tracking-widest">Открываем кафе...</p>
          </div>
        ) : (
          <>
            {/* СЦЕНА 1: Стол пуст */}
