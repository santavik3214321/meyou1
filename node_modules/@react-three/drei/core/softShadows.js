  ...
  scene.traverse(object => {
    if (object.material) {
      ...
      materials.forEach(material => {
        ...
        material.dispose == null || material.dispose();
...
function SoftShadows({
  ...
  React.useEffect(() => {
    ...
    const pcssReturn = hasIntensity ? 'return mix( 1.0, PCSS( shadowMap, shadowCoord ), shadowIntensity );' : 'return PCSS( shadowMap, shadowCoord );';
    const shader = (original.slice(0, frustumEnd) + '\n' + pcssReturn + original.slice(frustumEnd)).replace('#ifdef USE_SHADOWMAP', '#ifdef USE_SHADOWMAP\n' + pcss({
      size,
      samples,
      focus
    }, packedDepth));
